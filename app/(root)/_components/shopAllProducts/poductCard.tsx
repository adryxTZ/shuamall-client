...
const ShopProductCard: FC<ShopProductProps> = ({product}) => {
    const imageUrl = getProductImageUrl(product.product_thumbnails);
        ...
        <div>
            ...
            <span className="text-[9px] font-700 leading-none py-[6px] px-3 uppercase text-white rounded-full tracking-wider bg-qyellow">
              new
                ...
                <div className="product-card-details px-[30px] pb-[30px] relative">
                    <Link href={`/products/${product.product_uuid}`} passHref>
            ...
            <span className="main-price text-qgray line-through mr-2 text-[13px] font-600">
              $120
                        ...
                        <span className="text-qyellow font-600">TZS {Number(product.regular_price).toLocaleString()}/=</span>
                    </p>
                </div>
            </div>
        </div>
