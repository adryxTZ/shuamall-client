...
import {getProductImageUrl} from "@/utils/getValidImageUrl";
...
const getProductDetail = async (productId: string) => {
    ...
    try {
        const res = await fetch(endpoint + `/product/${productId}`);
...
const HomeProductDetails =  ({productId}: DetailsProps) => {
    const [productDetail, setProductDetail] = useState<Products>({} as Products);
    ...
    const imageUrl = getProductImageUrl(productDetail.product_thumbnails);


    // console.log("product id " +productId);
    // console.log("product Detailssss " + productDetail.product_title);
        ...
        <div>
            <div className="product-view-main-wrapper bg-white pt-[30px] w-full">
                <div className="breadcrumb-wrapper w-full ">
                    ...
                    {/*    <div>*/}
                    {/*        <div className="breadcrumb-wrapper font-400 text-[13px] text-qblack mb-[23px]"><span><a*/}
                    {/*            href="index.html"><span className="mx-1 capitalize">home</span></a><span*/}
                    {/*            className="sperator">/</span></span><span><a href="single-product"><span*/}
                    {/*            className="mx-1 capitalize">single product</span></a><span*/}
                    {/*            className="sperator">/</span></span></div>*/}
                    {/*    </div>*/}
                    {/*</div>*/}
                </div>
                <div className="w-full bg-white pb-[60px] pt-[3em]">
                    <div className="container-x mx-auto">
                        <div className="product-view w-full lg:flex justify-between ">
                                ...
                                <div className="w-full">
                                    ...
                                    <div className="flex gap-2 flex-wrap">
                                        <div
                                            ...
                                            <Image
                                                src={images.music} alt=""
                                                className="w-full h-full object-contain  "/></div>
                                        <div
                                            className="w-[110px] h-[110px] p-[15px] border border-qgray-border cursor-pointer">
                                            <Image
                                                src={images.music} alt=""
                                                className="w-full h-full object-contain opacity-50 "/></div>
                                        <div
                                            className="w-[110px] h-[110px] p-[15px] border border-qgray-border cursor-pointer">
                                            <Image
                                                src={images.music} alt=""
                            ...
                            <div className="flex-1">
                                <div className="product-details w-full mt-10 lg:mt-0"><span
                                    ...
                                    <div className="flex space-x-[10px] items-center mb-6">
                                        ...
                                        <span className="text-[13px] font-normal text-qblack">6
                                                    Reviews</span>
                                    </div>
                                    <div className="flex space-x-2 items-center mb-7"><span
                                        className="text-sm font-500 text-qgray line-through mt-2">$9.99</span><span
                                        className="text-2xl font-500 text-qred">TZS {Number(productDetail.regular_price).toLocaleString()}/=</span></div>
                                    <p
                                        className="text-qgray text-sm text-normal mb-[30px] leading-7">{productDetail.product_description}.</p>
                                    <div className="colors mb-[30px]"><span
                                        className="text-sm font-normal uppercase text-qgray mb-[14px] inline-block">COLOR</span>
                                        <div className="flex space-x-4 items-center">
                                            <div>
                                                <button type="button"
                                                        className="w-[20px] h-[20px] rounded-full focus:ring-2 ring-offset-2 flex justify-center items-center"><span

                                                    className="w-[20px] h-[20px] block rounded-full border"></span>
                                                </button>
                                            </div>
                                            <div>
                                                <button type="button"
                                    ...
                                    <div className="product-size mb-[30px]"><span
                                            ...
                                            <div
                                                ...
                                                <div className="my-select-box w-full">
                                                    <button type="button"
                                                        ...
                                                        <div><span className="text-[13px] text-qblack">Small</span>
                                                        </div>
                                                        <div className="flex space-x-10 items-center"><span
                                                            className="text-[13px] text-qblack">3”W x 3”D x
                                                                        7”H</span><span><svg width="11" height="7"
                                                                                             viewBox="0 0 11 7"
                                                                                             fill="none"
                                                                                             xmlns="http://www.w3.org/2000/svg">
                                                                            <path
                                    ...
                                    <div
                                        ...
                                        <div className="flex-1 h-full">
                                            ...
                                            >
                                                {/*<PhoneCall />*/}
                                                {showPhoneNumber ? (
                                                    <div className="text-lg font-bold flex gap-2 justify-center items-center">
                                                        <PhoneCall /> {productDetail.shops.shop_phone_number}
                                                    </div>
                                                ) : (
                                                    <span className="text-lg font-bold">Contact Seller</span>
                                                )}
                                    ...
                                    <div className="mb-[20px]">
                                        <p className="text-[13px] text-qgray leading-7"><span
                                            className="text-qblack">Category :</span> Kitchen</p>
                                        <p className="text-[13px] text-qgray leading-7"><span
                                            className="text-qblack">Tags :</span> Beer, Foamer</p>
                                        <p className="text-[13px] text-qgray leading-7"><span
                                            className="text-qblack">SKU:</span> KE-91039</p>
                                    </div>
                                    <div className="flex space-x-2 items-center mb-[20px]">
                                                <span><svg width="12" height="13" viewBox="0 0 12 13" fill="none"
                                                           xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                        ...
                                        <button type="button"
                                                className="text-qred font-semibold text-[13px]">Report This
                                            Item
                                        </button>
                                    </div>
                                    <div className="social-share flex items-center w-full"><span
                                        className="text-qblack text-[13px] mr-[17px] inline-block">Share
                                                    This</span>
                                        <div className="flex space-x-5 items-center"><span><svg width="10"
                                                                                                height="16"
                                                                                                viewBox="0 0 10 16"
                                                                                                fill="none"
                                                                                                xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                                ...
                                                                fill="#3E75B2"></path>
                                                        </svg></span><span><svg width="16" height="16"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#E12828"></path>
                                                        </svg></span><span><svg width="18" height="14"
