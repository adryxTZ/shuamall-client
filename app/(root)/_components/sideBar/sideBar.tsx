...
const ShopSideBar = () => {
    return (
        <div className="lg:w-[270px] dark:bg-dark">
            <div
                className="filter-widget w-full fixed lg:relative left-0 top-0 h-screen z-10 lg:h-auto overflow-y-scroll lg:overflow-y-auto bg-white
                px-[30px] pt-[40px] mb-[30px]  hidden lg:block dark:bg-dark ">
                <div className="filter-subject-item pb-10 border-b border-gray-border">
                    <div className="subject-title mb-[30px]">
                        <h1 className="text-black text-base font-500 dark:text-white">Product categories</h1>
                    </div>
