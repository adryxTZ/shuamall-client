...
//             try {
//                 setLoading(true);
//                 // const response = await axios.get('http://127.0.0.1:8000/api/dashboard/productAnalytic', {
//                 const response = await axios.get('http://127.0.0.1:8000/api/dashboard/ActiveProductCount', {
//                     headers: {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await axios.get(
                    // 'http://127.0.0.1:8000/api/dashboard/ActiveProductCount', {
                    'https://api.shuamall.com/api/dashboard/ActiveProductCount', {
                        headers: {
                            Authorization: `Bearer ${session?.accessToken}`,
                        },
                ...
                if (response.data.success) {
                    ...
                    setViewsCount(response.data.active_product_count);
                    // setViewsCount(response.data.views_count);
                } else {
                    // @ts-ignore
                    setError(new Error("Failed to fetch data"));
