...
const ShopOffer = () => {
    return (
        <div>
            <div className="discount-banner w-full h-[307px] bg-cover flex justify-center items-center bg-blue-200"
                 // style={{backgroundImage: "url('/assets/img/shops/1.webp')"}}
            >
                <div>
                    <div>
                        <h1 className="sm:text-3xl text-xl font-700 text-qblack mb-2 text-center">Get <span
                            className="mx-1 text-qyellow">20%</span> Off Discount Coupon</h1>
                        <p className="text-center sm:text-[18px] text-sm font-400">by Subscribe our Newsletter</p>
                    </div>
                    <div className="sm:w-[543px] w-[300px] h-[54px] flex mt-8">
                        <div
                        ...
                        <button type="button"
                                className="sm:w-[158px] w-[80px] h-full bg-qyellow text-sm font-600">Get the Coupon
                        </button>
                    </div>
                </div>
            </div>
