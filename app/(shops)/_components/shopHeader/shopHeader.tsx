...
import ShopNavBar from "@/app/(shops)/_components/shopHeader/shopNavBar";
import Image from "next/image";
import {images} from "@/shared/constants/image";
import ShopTop from "@/app/(shops)/_components/shopHeader/shopTop";
...
const ShopHeader: React.FC<shopHeader> = ({shopName,shopLogo }) => {
    return (
        <header className="w-full dark:bg-dark">
            <ShopTop/>
                    ...
                    <div className="flex items-center justify-between  py-2 md:py-4">
                        <div className="relative flex-shrink-0 lg:hidden">
                            <button
                                ...
                                <svg
                                    ...
                                    strokeLinecap="round" strokeLinejoin="round" className="text-xl lg:text-2xl"
                        ...
                        <div
                            ...
                            >
                                ...
                                <Image src={shopLogo} height={40} width={100} alt="Shuamall logo"/>
                                    <h1 className="font-black text-lg">{shopName}</h1>
                                </Link>

                            </div>
                        </div>
                        <div
                            className="w-full transition-all duration-200 ease-in-out hidden lg:flex lg:max-w-[450px] xl:max-w-[650px] 2xl:max-w-[900px] lg:mx-10">
                            <div className="overlay cursor-pointer"></div>
                            <div className="w-full flex flex-col justify-center flex-shrink-0 relative z-30">
                                <div className="flex flex-col mx-auto w-full">
                                    <form className="flex w-full relative "  role="search"><label
                                        htmlFor="top-bar-search" className="flex flex-1 items-center py-0.5"><input
                                        id="top-bar-search"
                                        className="text-heading outline-none w-full h-[45px] ps-5 md:ps-6 pe-14 md:pe-16 bg-skin-full text-skin-base text-sm rounded-full transition-all duration-200 focus:border-skin-primary focus:ring-1 focus:ring-skin-form bg-skin-one"
                                        placeholder="Search the store" aria-label="top-bar-search"
                                        autoComplete="off" value="" name="search"/></label><span
                                        className="w-14 md:w-16 h-full absolute top-0 end-0 flex flex-shrink-0 justify-center items-center focus:outline-none"><svg
            ...
            <div
                className="nav-widget-wrapper w-full  h-[60px] relative z-30 bg-qyellow  quomodo-shop-nav-bar lg:block hidden">
                            ...
                            <div className="category-and-nav flex xl:space-x-7 space-x-3 items-center">
                                <div
                                    ...
                                    <button type="button" className="w-full h-full flex justify-between items-center">
                                        <div className="flex space-x-3 items-center"><span><svg className="fill-current"
                                                                                                width="14" height="9"
                                                                                                viewBox="0 0 14 9"
                                                                                                fill="none"
                                                    ...
                                                    </svg></span><span className="text-sm font-600 text-qblacktext">All
                                                    Categories</span></div>
                                        {/*<div>*/}
                                    ...
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="12" height="16"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span*/}
                                    {/*                    className="text-xs font-400">Mobile &amp;*/}
                                    {/*                    Laptops</span></div>*/}
                                    {/*                <div><span><svg className="fill-current" width="6" height="9"*/}
                                    {/*                                viewBox="0 0 6 9" fill="none"*/}
                                    {/*                                xmlns="http://www.w3.org/2000/svg">*/}
                                    {/*                                <rect x="1.49805" y="0.818359" width="5.78538"*/}
                                    {/*                                      height="1.28564"*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="19" height="17"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span className="text-xs font-400">Gaming*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="18" height="14"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span*/}
                                    {/*                    className="text-xs font-400">Image &amp;*/}
                                    {/*                    Video</span></div>*/}
                                    {/*                <div><span><svg className="fill-current" width="6" height="9"*/}
                                    {/*                                viewBox="0 0 6 9" fill="none"*/}
                                    {/*                                xmlns="http://www.w3.org/2000/svg">*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="20" height="16"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span*/}
                                    {/*                    className="text-xs font-400">Vehicles</span></div>*/}
                                    {/*                <div><span><svg className="fill-current" width="6" height="9"*/}
                                    {/*                                viewBox="0 0 6 9" fill="none"*/}
                                    {/*                                xmlns="http://www.w3.org/2000/svg">*/}
                                    {/*                                <rect x="1.49805" y="0.818359" width="5.78538"*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="17" height="16"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span*/}
                                    {/*                    className="text-xs font-400">Furnitures</span></div>*/}
                                    {/*                <div><span><svg className="fill-current" width="6" height="9"*/}
                                    {/*                                viewBox="0 0 6 9" fill="none"*/}
                                    {/*                                xmlns="http://www.w3.org/2000/svg">*/}
                                    {/*                                <rect x="1.49805" y="0.818359" width="5.78538"*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="17" height="18"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span className="text-xs font-400">Sport*/}
                                    {/*                        </span></div>*/}
                                    {/*                <div><span><svg className="fill-current" width="6" height="9"*/}
                                    {/*                                viewBox="0 0 6 9" fill="none"*/}
                                    {/*                                xmlns="http://www.w3.org/2000/svg">*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="17" height="21"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span*/}
                                    {/*                    className="text-xs font-400">Food &amp;*/}
                                    {/*                    Drinks</span></div>*/}
                                    {/*                <div><span><svg className="fill-current" width="6" height="9"*/}
                                    {/*                                viewBox="0 0 6 9" fill="none"*/}
                                    {/*                                xmlns="http://www.w3.org/2000/svg">*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="16" height="18"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span className="text-xs font-400">Fashion*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="13" height="20"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span*/}
                                    {/*                    className="text-xs font-400">Toilet &amp;*/}
                                    {/*                    Sanitation</span></div>*/}
                                    {/*                <div><span><svg className="fill-current" width="6" height="9"*/}
                                    {/*                                viewBox="0 0 6 9" fill="none"*/}
                                    {/*                                xmlns="http://www.w3.org/2000/svg">*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="14" height="20"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span className="text-xs font-400">Makeup*/}
                                    {/*                            Corner</span></div>*/}
                                    {/*                <div><span><svg className="fill-current" width="6" height="9"*/}
                                    {/*                                viewBox="0 0 6 9" fill="none"*/}
                                    {/*                                xmlns="http://www.w3.org/2000/svg">*/}
                                    ...
                                    {/*                className="flex justify-between items-center px-5 h-10 bg-white  transition-all duration-300 ease-in-out cursor-pointer text-qblack hover:bg-qyellow">*/}
                                    {/*                <div className="flex items-center space-x-6"><span><svg*/}
                                    {/*                    className="fill-current" width="12" height="18"*/}
                                    ...
                                    {/*                                </path>*/}
                                    {/*                            </svg></span><span className="text-xs font-400">Baby*/}
                                    {/*                            Items</span></div>*/}
                                    {/*                <div><span><svg className="fill-current" width="6" height="9"*/}
                                    {/*                                viewBox="0 0 6 9" fill="none"*/}
                                    {/*                                xmlns="http://www.w3.org/2000/svg">*/}
                                ...
                                <div className="nav">
                                    <ul className="nav-wrapper flex xl:space-x-10 space-x-5">
                                        ...
                                        <li className="relative">
                                            <Link href="/">
                                            <span
                                            className="flex items-center text-sm font-600 cursor-pointer text-qblacktext"><span>Home</span><span
                                            className="ml-1.5 "></span></span>
                                            </Link>
                                        ...
                                        <li>
                                            ...
                                            <span
                                            className="flex items-center text-sm font-600 cursor-pointer text-qblacktext"><span>Products</span><span
                                            className="ml-1.5 "></span></span>
                                            </Link>
                                        </li>
                                        <li><span
                                            className="flex items-center text-sm font-600 cursor-pointer text-qblacktext"><span>About</span></span>
                                        </li>

                                        <li><span
                                            className="flex items-center text-sm font-600 cursor-pointer text-qblacktext"><span>Contact</span></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
