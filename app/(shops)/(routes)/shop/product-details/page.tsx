                        ...
                        <div className="product-view w-full lg:flex justify-between ">
                            ...
                            <div className="flex-1">
                                <div className="product-details w-full mt-10 lg:mt-0"><span
                                    ...
                                    <p  
                                       className="text-qgray text-sm text-normal mb-[30px] leading-7">It is a long
                                        established fact that a reader will be distracted by the readable there
                                    ...
                                    <div  
                                        ...
                                        <div
                                            ...
                                            <div className="flex justify-between items-center w-full">
                                                <button
                                                    type="button" className="text-base text-qgray">-
                                                </button>
                                                <span
                                                    className="text-qblack">1</span>
                                                <button type="button"
