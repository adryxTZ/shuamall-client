...
import {Navbar, Categories} from "@/shared";
                    ...
                    <div className="flex flex-wrap items-center -mx-4">
                        ...
                        <div className="w-full px-4 md:w-1/3 lg:w-1/2">
                            <div className="items-center justify-end hidden md:flex space-x-2">
                                ...
                                <span
                                    className="flex relative text-sm font-semibold text-primary lg:text-primary dark:text-gray-900">Sign in </span>
                                        </a>
                                    </div>
                                </div>
                                <div>
                                ...
                                <span
                                    className="flex relative text-sm font-semibold text-white dark:text-white lg:text-primary lg:dark:text-white">Get Started </span>
                                        </Link>
                                    </div>
                                </div>
                            </div>
