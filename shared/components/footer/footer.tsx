...
const Footer = () => {
    return (
        <footer className="backgroundHeader dark:bg-dark-2">
            <div className="container mx-auto">
                <div
                    className="px-6 pt-20 pb-6 rounded-lg backgroundHeader dark:bg-dark-2 sm:px-8 xl:px-14"
                >
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full px-4 md:w-5/12 lg:w-1/3">
                            <div className="mb-14">
                                <a href="#" className="inline-block mb-4">
                                    {/*<MainLogo/>*/}
                                    <Image src={images.logo} height={45} alt="Shuamall logo"/>
                                ...
                                <p className="mb-8 text-base text-body-color dark:text-dark-6">
                                    Explore the Shua Mall. Shop Online for Fashion, Electronics, Home Decor, Toys, and More. Discover Convenience, Variety, and Exclusive Deals. Embrace the Future of Shopping. Start Your Virtual Shopping Journey Today.
                                </p>

                                <div className="flex items-center space-x-3">
                                    <a
                                        href="#"
                                        className="text-body-color dark:text-dark-6 hover:border-primary hover:bg-primary flex h-8 w-8 items-center justify-center rounded-full border-[.5px] border-stroke dark:border-dark-3 bg-white dark:bg-dark transition-all hover:text-white"
                                    >
                                        <svg
                                            width="16"
                                            height="16"
                        ...
                        <div className="w-full px-4 md:w-7/12 lg:w-1/3">
                            <div className="mb-14">
                                ...
                                <div
                                    className="flex flex-wrap -mx-4 space-y-3 sm:space-y-0 lg:space-y-3 xl:space-y-0"
                                >
                                    <div className="w-full px-4 sm:w-1/2 lg:w-full xl:w-1/2">
                                        <ul className="space-y-3">
                                            <li>
                                                <a
                                                    href="#"
                                                    className="inline-block text-base text-body-color dark:text-dark-6 hover:text-primary"
                                                >
                                                    Shops
                                                </a>
                                            </li>
                            ...
                            <div className="mb-14">
                                ...
                                <form className="flex items-center justify-between">
                                    <input
                                        ...
                                        className="focus:border-primary h-[54px] w-full rounded-tl-lg rounded-bl-lg border border-stroke dark:border-dark-3 bg-white dark:bg-dark px-5 outline-none"
                                    />
                                    <button
                                        className="h-[54px] rounded-tr-lg rounded-br-lg border border-l-0 border-stroke dark:border-dark-3 bg-white dark:bg-dark px-5"
                                    >
                                        <svg
                                            width="24"
                                            height="24"
                    ...
                    <div className="flex flex-wrap items-center -mx-4">
                        <div className="w-full px-4 xl:w-8/12">
                            <div className="flex flex-wrap justify-center -mx-3 xl:justify-start">
                                <a
                                    href="#"
                                    className="inline-flex px-3 mb-4 text-base text-body-color dark:text-dark-6 hover:text-primary"
                                >
                                    Payment
                                </a>
                                <a
                        ...
                        <div className="w-full px-4 xl:w-4/12">
                            ...
                            {/*    <img*/}
                            {/*        src="src/assets/ecom-images/footers/footer-02/payment.svg"*/}
                            {/*        alt="payment"*/}
                            {/*        className="max-w-full mx-auto xl:ml-0"*/}
                            {/*    />*/}
                            {/*</div>*/}
                        </div>
                    </div>
